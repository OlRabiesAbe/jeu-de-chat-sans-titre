...
function getLevelTwoEnts(gameEngine) {
	...
	for(var i = 2; i < 5; i++){
		var brick = new Tile(gameEngine, "./img/building.png", 0, 0,
				...
				128, 128, 128, 128, {allDir:true, bottom:true});
		lOneEnts.push({type:"Platform", ent:brick});
	}
	for(var i = 2; i < 5; i++){
		var brick = new Tile(gameEngine, "./img/building.png", 0, 0,
	...
	var box6 = new Tile(gameEngine, "./img/box.png", 0, 0,
			...
			128, 128, 128, 128, {allDir:true, bottom:true});
	lOneEnts.push({type:"Platform", ent:box6});
	lOneEnts.push({type:"Enemy", ent:new Range(gameEngine, 128 * 19, 128 * 5 - 150)})
	lOneEnts.push({type:"Enemy", ent:new EnemyIdle(gameEngine, 128 * 36, 128 * 3 - 37 )})
	lOneEnts.push({type:"Enemy", ent:new EnemyIdle(gameEngine, 128 * 45, 128 * 3 - 37 )})
	lOneEnts.push({type:"Enemy", ent:new EnemyPace(gameEngine, 128 * 68, 768 - 128 - 95)})
	
	lOneEnts.push({type:"Enemy", ent:new Rat(gameEngine, 128 * 31, 640 - 64)})
	lOneEnts.push({type:"Enemy", ent:new Rat(gameEngine, 128 * 50, 640 - 64)})
	...
	lOneEnts.push({type:"Enemy", ent:new Wire(gameEngine, 128 * 26.5, 128 * 2)})
	var wire = new Wire(gameEngine, 128 * 79, 128 * 2)	
	lOneEnts.push({type:"Enemy", ent:wire})
